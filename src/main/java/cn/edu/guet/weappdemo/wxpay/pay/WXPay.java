package cn.edu.guet.weappdemo.wxpay.pay;



import cn.edu.guet.weappdemo.menu.*;
import cn.edu.guet.weappdemo.wxpay.sdk.WXPayUtil;
import cn.edu.guet.weappdemo.wxpay.util.DateUtil;
...
import cn.edu.guet.weappdemo.menu.mainmenu;
...
public class WXPay {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //unifiedOrder();
        // 商家扫用户手机的条形码
        // scanCodeToPay("130494011819665962");
    ...
    public static String scanCodeToPay(String auth_code) throws Exception {
        ...
        cn.edu.guet.weappdemo.wxpay.sdk.WXPay wxpay = new cn.edu.guet.weappdemo.wxpay.sdk.WXPay(config);
    ...
    下单：生成二维码
     */
    public static void unifiedOrder(float cost) {
        Map<String, String> resultMap = new HashMap();
        String openid = "ouR0E1oP5UGTEBce8jZ_sChfH26g";
        MyConfig config = null;
        cn.edu.guet.weappdemo.wxpay.sdk.WXPay wxpay = null;
        try {
            config = new MyConfig();
            wxpay = new cn.edu.guet.weappdemo.wxpay.sdk.WXPay(config);
        } catch (Exception e) {
            e.printStackTrace();
        }
        //生成的随机字符串
        ...
        int total_fee = (int)(cost*100);//商品描述
        String body = "烧烤总额";
        //商户订单号
        ...
        data.put("notify_url", "http://5265h8v181.qicp.vip/result");
      ...
      //  data.put("openid", openid);
        //data.put("attach","id,1111;price,18.00;amount:1");
    ...
    public static void createQRCode(Map<String, String> map) throws Exception {
        ...
        File outputFile = new File("C:\\study\\hjlproject\\bbqshop" + File.separator + "二维码.jpg");
